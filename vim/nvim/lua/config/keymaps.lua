...
keymap('t', '<A-h>', '<C-\\><C-n><C-w>h', { noremap = true, desc = "Move to left window" })
keymap('t', '<A-j>', '<C-\\><C-n><C-w>j', { noremap = true, desc = "Move to bottom window" })
keymap('t', '<A-k>', '<C-\\><C-n><C-w>k', { noremap = true, desc = "Move to top window" })
keymap('t', '<A-l>', '<C-\\><C-n><C-w>l', { noremap = true, desc = "Move to right window" })
keymap('t', '<A-o>', '<C-\\><C-n><C-w><C-p>', { noremap = true, desc = "Go to previous window" })
