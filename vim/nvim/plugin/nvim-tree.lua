...
local function on_attach(bufnr)
    ...
    keymap('n', '<c-x>',     api.node.open.horizontal,         opts('Split Horizontal'))
    keymap('n', '<c-v>',     api.node.open.vertical,           opts('Split Vertical'))
    keymap('n', 'yy',        api.fs.copy.node,                 opts('Copy'))
    keymap('n', 'dd',        api.fs.cut,                       opts('Cut'))
    keymap('n', '<leader>r', api.fs.rename_basename,           opts('Rename: Basename'))
    keymap('n', '<leader>R', api.fs.rename,                    opts('Rename'))
